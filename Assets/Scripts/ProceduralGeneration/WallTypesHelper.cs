...
public static class WallTypesHelper
{
    ...
    public static HashSet<int> wallFull = new HashSet<int>
    {
        ...
        0b10111111, // Only diagonal top right open
        0b11101111, // Only diagonal down right open
        0b11111011, // Only diagonal down left open
        0b11111110 // Only diagonal top left open
